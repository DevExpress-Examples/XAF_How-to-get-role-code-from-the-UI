...
namespace XafSolution.Blazor.Server {
    public partial class XafSolutionBlazorApplication : BlazorApplication {
        public XafSolutionBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafSolutionBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
